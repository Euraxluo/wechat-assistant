...
AUTHOR = "AI提效实验室"
DIGEST = "内蒙古16岁田径少年庆祝夺冠后，凌晨拍门玩闹遭36岁男子持刀捅死，临终对母亲说“妈妈我好疼，想喝水”。母亲今日冲上微博热搜第一：孩子有错，但错不至死。案件已于7月3日移送检察院审查起诉。"
ARTICLE_HTML_PATH = os.path.join(PROJECT_DIR, "articles", "article_door_stabbing_0713_v2.html")
COVER_IMAGE_PATH = os.path.join(PROJECT_DIR, "articles", "images", "Editorial_illustration_cover___2026-07-13T04-56-13.png")
