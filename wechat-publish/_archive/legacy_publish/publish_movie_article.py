...
# ===================== 配置区（每次发布只改这里） =====================
TITLE = "功夫女足：周星驰时隔7年回归，3天5亿票房背后是情怀还是套路？"
AUTHOR = "AI提效实验室"
DIGEST = "周星驰自编自导《功夫女足》7月11日上映，3天票房破5亿，但豆瓣开分6.6、口碑两极分化。情怀加成还能撑多久？"
ARTICLE_HTML_PATH = os.path.join(PROJECT_DIR, "articles", "article_movie_kungfu_girls_0713.html")
COVER_IMAGE_PATH = os.path.join(PROJECT_DIR, "articles", "images", "Editorial_illustration_cover___2026-07-13T06-05-39.png")
ARTICLE_IMAGES_DIR = os.path.join(PROJECT_DIR, "articles", "images")
# =====================================================================

MP_URL = "https://mp.weixin.qq.com/"
SCREENSHOT_DIR = "/tmp/wechat_movie_shots"
