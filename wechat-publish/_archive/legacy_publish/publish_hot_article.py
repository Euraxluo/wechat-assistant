...
ARTICLE_HTML_PATH = os.path.join(PROJECT_DIR, "articles", "article_door_stabbing_0713_极简.html")
TITLE = "16岁少年拍门玩闹被捅死，母亲说：错不至死"
AUTHOR = "AI提效实验室"
DIGEST = "内蒙古16岁高中生庆祝田径夺冠后，凌晨拍门玩闹遭36岁男子持刀捅死。临终对母亲说「妈妈我好疼」。母亲今日冲上微博热搜第一：孩子有错，但错不至死。案件已移送检察院审查起诉。"
