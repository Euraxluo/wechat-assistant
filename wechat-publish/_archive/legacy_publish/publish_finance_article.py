...
# ===================== 配置区（每次发布只改这里） =====================
TITLE = "A股午盘跳水：三大指数集体跌超1%，超4500股飘绿，医药银行逆势扛旗"
AUTHOR = "AI提效实验室"
DIGEST = "7月13日早盘A股集体走弱，沪指午盘跌1.54%、深成指跌2.61%、创业板指跌2.38%，超4500只个股下跌；医药与银行逆势抗跌，创新药主力净流入近10亿元。亚太方面韩国股市暴跌触发熔断。本文为市场信息整理，不构成投资建议。"
ARTICLE_HTML_PATH = os.path.join(PROJECT_DIR, "articles", "article_finance_0713_midday.html")
COVER_IMAGE_PATH = os.path.join(PROJECT_DIR, "articles", "images", "Editorial_illustration_cover___2026-07-13T05-24-38.png")
ARTICLE_IMAGES_DIR = os.path.join(PROJECT_DIR, "articles", "images")
# =====================================================================

MP_URL = "https://mp.weixin.qq.com/"
SCREENSHOT_DIR = "/tmp/wechat_finance_shots"  # 改用 /tmp，不触碰项目 screenshots/，避免沙箱批量删除拦截
