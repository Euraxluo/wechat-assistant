...
/Users/echo/.workbuddy/binaries/python/envs/default/bin/python \
    /Users/echo/project/wechat-assistant/wechat-publish/publish_lifework_article.py
"""
import asyncio
import json
import os
...
# ===================== 配置区 =====================
TITLE = '双休不够用了？年轻人喊出"上四休三"，不是懒是清醒'
AUTHOR = "AI提效实验室"
DIGEST = '7月8日"其实我连双休都不满意"冲上热搜。双休正在变成"假性休息"，年轻人开始重新定义工作与生活的关系——上四休三不是懒，是对时薪的清醒认知。'
ARTICLE_HTML_PATH = os.path.join(PROJECT_DIR, "articles", "article_lifework_fourday_week_0713.html")
COVER_IMAGE_PATH = os.path.join(PROJECT_DIR, "articles", "images", "Cover_image_for_article_about__2026-07-13T06-59-37.png")
ARTICLE_IMAGES_DIR = os.path.join(PROJECT_DIR, "articles", "images")
# ==================================================

MP_URL = "https://mp.weixin.qq.com/"
SCREENSHOT_DIR = "/tmp/wechat_lifework_shots"
